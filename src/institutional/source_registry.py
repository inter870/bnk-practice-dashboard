...
SOURCE_REGISTRY: dict[str, DataSourceDefinition] = {
    ...
    "dart_public_disclosures": DataSourceDefinition(
        source_id="dart_public_disclosures",
        display_name_ko="DART 최근공시 공개 페이지",
        category="dart_disclosures",
        adapter_id="dart.fss.or.kr/dsac001/mainAll.do",
        source_type="public_web",
        requires_auth=False,
        supports_eod=True,
        expected_latency="delayed",
        officialness_level="public_web",
        reliability_base_score=60,
        legal_access_mode="no_key_required",
        fallback_rank=40,
        user_visible_warning_ko="공개 페이지 기반 보조 데이터로 구조 변경 또는 지연 가능성이 있습니다.",
    ),

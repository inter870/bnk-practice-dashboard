...
.heatmap-strong { background: linear-gradient(180deg, rgba(16,185,129,.96), rgba(5,150,105,.86)); }
.heatmap-good { background: linear-gradient(180deg, rgba(14,165,233,.92), rgba(2,132,199,.82)); }
.heatmap-neutral { background: linear-gradient(180deg, rgba(139,92,246,.88), rgba(109,40,217,.78)); }
.heatmap-weak { background: linear-gradient(180deg, rgba(245,158,11,.96), rgba(217,119,6,.84)); color: #111827; }
.heatmap-risk { background: linear-gradient(180deg, rgba(244,63,94,.96), rgba(190,18,60,.86)); }
...
.tone-good { color: var(--korea-positive) !important; }
.tone-risk { color: var(--korea-risk) !important; }
.tone-warn { color: var(--korea-caution) !important; }
.tone-info { color: var(--korea-info) !important; }
.korea-flow-pos { color: var(--korea-positive); font-weight: 900; }
.korea-flow-neg { color: var(--korea-risk); font-weight: 900; }
